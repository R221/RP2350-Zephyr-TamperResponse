...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_RASPBERRYPI_PICO_RNG_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_RASPBERRYPI_PICO_ROSC_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_RASPBERRYPI_PICO_SIO_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RPI_PICO_SIGNING_KEY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RPI_PICO_USE_ROMFUNC, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UDC_RPI_PICO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UDC_RPI_PICO_STACK_SIZE, 512);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UDC_RPI_PICO_THREAD_PRIORITY, 8);
